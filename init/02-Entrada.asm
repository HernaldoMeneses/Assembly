segment .data
    ...
    ; eax
    SYS_EXIT    equ 0x0     ; Codigo de chamada para finalizar
    SYS_READ    equ 0x1     ; Operacao realizada com sucesso
    SYS_WRITE   equ 0x3     ; Operação de Leitura
    ; ebx
    RET_EXIT    equ 0x4     ; Operação de Escrita
