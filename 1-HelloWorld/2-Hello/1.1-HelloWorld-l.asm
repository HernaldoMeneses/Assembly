...
section .data
    msg db "Hello World" ;ponteiro msg
    tam equ $- msg ;tamanho igual ao tamanho de msg (pra não precisar contar o numero de caracters use $-)
section .text
    global _start
        mov eax, 0x4 ; SO vamos usar a saida padrão
        mov ebx, 0x1 ; SO EBX recebe a saida padrão
        mov ecx, msg
        mov edx, tam
        int 0x80 ; SO exec all
